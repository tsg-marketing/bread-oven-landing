...
const items = [
  ...
  { icon: 'Thermometer', t: 'Равномерный прогрев', d: 'Стабильное распределение температуры по всей камере — выпечка одинакового качества' },
  { icon: 'Leaf', t: 'Высокая энергоэффективность', d: 'Современная конструкция снижает расход энергии и эксплуатационные затраты без потери производительности' },
